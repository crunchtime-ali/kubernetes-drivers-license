Ein `Ingress` ermöglicht eingehende Verbindungen in das Cluster. Dadurch ist es möglich, dass Requests von außerhalb des Kubernetes Netzwerk den korrekten `Pod` bzw. `Service` erreichen können.
